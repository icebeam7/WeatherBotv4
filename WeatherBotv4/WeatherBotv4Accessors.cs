...
namespace WeatherBotv4
{
    ...
    /// </summary>
    public class WeatherBotv4Accessors
    {
        /// <summary>
        ...
        public WeatherBotv4Accessors(ConversationState conversationState)
        {
        ...
        public static string CounterStateName { get; } = $"{nameof(WeatherBotv4Accessors)}.CounterState";
